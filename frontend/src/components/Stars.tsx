 ...
 * @param {number} props.rating – Rating of the Basketball court
 * @param {React.Dispatch<React.SetStateAction<number>>} props.handleRating – Update rating
 * @param {string} props.username – username of user
...
export default function Stars(
    ...
    // function handleClick(starRating : number){
    //     setError("")
