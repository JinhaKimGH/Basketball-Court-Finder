...
export default function SignUpForm(
    ...
    // TODO: Fetches email & password data from database
    ...
    // TODO: Handles users signup. Sets email + password and writes it to the database
    function handleSignup(event : FormEvent<HTMLDivElement>){
