 ...
 * @param {React.Dispatch<React.SetStateAction<string>>} props.handleUser – Sets username
 * @param {React.Dispatch<React.SetStateAction<Array<string>>>} props.handleArr – Sets review data
 * @returns {JSX.Element}
 */
export default function LoginForm(
    props : {
        handleClick: React.Dispatch<React.SetStateAction<string>>,
        handleUser: React.Dispatch<React.SetStateAction<string>>
    }){
